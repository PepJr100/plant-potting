...
class StubPlantIdentifierTest {
    ...
    @Test
    fun deterministicReturnsStableResultAcrossRuns() =
        runBlocking {
    ...
    @Test
    fun deterministicResultIsAlwaysOneOfKbSpecies() =
        runBlocking {
    ...
    @Test
    fun deterministicSourceIsStubDeterministic() =
        runBlocking {
            val identifier = StubPlantIdentifier(kb = kb(speciesList))
            val result = identifier.identify(ByteArray(0))
    ...
    @Test
    fun randomModeOnlyReturnsSpeciesPresentInKb() =
        runBlocking {
            val identifier =
                StubPlantIdentifier(
                    kb = kb(speciesList),
    ...
    @Test
    fun deterministicPicksMonsteraIfPresent() =
        runBlocking {
            val identifier = StubPlantIdentifier(kb = kb(speciesList))
            val result = identifier.identify(ByteArray(0))
    ...
    @Test
    fun deterministicFallsBackToFirstIfNoMonstera() =
        runBlocking {
